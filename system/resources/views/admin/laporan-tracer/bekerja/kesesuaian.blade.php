...
@section('content')
    ...
    <script>
        Highcharts.chart('kesesuaian_all', {
            ...
            title: {
                text: 'Kesesuaian Kompetensi dengan Bidang Pekerjaan Alumni',
                align: 'left'
            },
            tooltip: {
        ...
        function createChart(tahun, item) {
            ...
            Highcharts.chart(className, {
                ...
                title: {
                    text: `Data Persentase Kesesuaian Kompetensi dengan Bidang Pekerjaan Alumni Tahun Angkatan ${tahun}`,
                    align: 'left'
                },
                tooltip: {
