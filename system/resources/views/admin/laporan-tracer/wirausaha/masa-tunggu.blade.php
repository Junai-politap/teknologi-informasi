...
<script>
    ...
    Highcharts.chart('masa_tunggu_2015', {
        ...
        title: {
            text: 'Kapan Waktu yang diperlukan untuk mulai berwirusaha Tahun Angkatan 2015',
            align: 'left'
        },
        tooltip: {
    ...
    Highcharts.chart('masa_tunggu_2016', {
        ...
        title: {
            text: 'Kapan Waktu yang diperlukan untuk mulai berwirusaha Tahun Angkatan 2016',
            align: 'left'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.0f}%</b>'
    ...
    Highcharts.chart('masa_tunggu_2017', {
        ...
        title: {
            text: 'Kapan Waktu yang diperlukan untuk mulai berwirusaha Tahun Angkatan 2017',
            align: 'left'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.0f}%</b>'
    ...
    Highcharts.chart('masa_tunggu_2018', {
        chart: {
            plotBackgroundColor: null,
            plotBorderWidth: null,
            plotShadow: false,
        ...
        title: {
            text: 'Kapan Waktu yang diperlukan untuk mulai berwirusaha Tahun Angkatan 2018',
            align: 'left'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.0f}%</b>'
    ...
    Highcharts.chart('masa_tunggu_2019', {
        ...
        title: {
            text: 'Kapan Waktu yang diperlukan untuk mulai berwirusaha Tahun Angkatan 2019',
            align: 'left'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.0f}%</b>'
