...
@include('section.notif')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><strong> Data Pimpinan</strong></h3>

            <button class="btn btn-primary float-right" data-toggle="modal" data-target="#modal-lg"><span
                    class="fa fa-user-plus"></span> Tambah Pimpinan</button>
        </div>
        <div class="card-body">
                    ...
                    @foreach ($list_pimpinan as $pimpinan)
                        <tr>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="{{ url("admin/show-pimpinan/$pimpinan->id") }}" class="btn btn-info"><span
                                            class="fa fa-info"></span> Lihat</a>

                                    <a href="{{ url("admin/edit-pimpinan/$pimpinan->id") }}" class="btn btn-warning"><span
                                            class="fa fa-edit"></span> Edit</a>

                                    <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?')" href="{{ url("admin/delete-pimpinan/$pimpinan->id") }}" class="btn btn-danger"><span
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="{{ url('admin/store-pimpinan') }}" method="POST"
