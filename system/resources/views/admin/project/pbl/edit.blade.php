...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="form" data-parsley-validate="" action="{{ url('admin/update-berita', $berita->id) }}" method="POST"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9 col-lg-10">
                        <textarea name="detail" class="form-control">{!! nl2br($berita->detail) !!}</textarea>
                    </div>
                </div>
                <div class="form-group row">
