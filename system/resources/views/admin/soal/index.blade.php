                    ...
                    @foreach ($list_soal as $soal)
                        <tr>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="{{ url("admin/show-soal/$soal->id") }}" class="btn btn-info"><span
                                            class="fa fa-info"></span> Lihat</a>

                                    <a href="{{ url("admin/edit-soal/$soal->id") }}" class="btn btn-warning"><span
                                            class="fa fa-edit"></span> Edit</a>

                                    <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?')" href="{{ url("admin/delete-soal/$soal->id") }}" class="btn btn-danger"><span
