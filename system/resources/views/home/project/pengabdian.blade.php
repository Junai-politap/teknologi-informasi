    ...
    <section class="choosing-area">
        <div class="container">
            <ul class="nav nav-tabs mb-5" id="myTab" role="tablist">
                @foreach ($list_pengabdian->groupBy('tahun') as $tahun => $val)
                    <li class="nav-item">
            ...
            <div class="tab-content" id="myTabContent">
                @foreach ($list_pengabdian->groupBy('tahun') as $tahun => $list_pengabdian)
                                                    ...
                                                    <div class="modal-dialog modal-lg" style="margin-top: 10%">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title text-center"> {{ $pengabdian->judul }}
                                                                </h4>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <label class="col-form-label">
                                                                                : {{ $pengabdian->anggota_dosen }}</label>
                                                                        </div>
                                                                    </div>
                                                                    <hr>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <label class="col-form-label">
                                                                                : {{ $pengabdian->anggota_mahasiswa }}</label>
                                                                        </div>
                                                                    </div>
                                                                    <hr>
